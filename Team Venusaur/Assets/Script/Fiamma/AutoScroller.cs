...
public class AutoScroller : MonoBehaviour       //script preso da qua https://forum.unity.com/threads/dropdown-autoscroller.441424/ non l'ho totalmente modificato
{
    ...
    void Update()
    {
        ...
        else
        {
            ...
            if (ControllerCheck.controllerPlugged)
            {
