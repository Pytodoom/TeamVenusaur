...
public class Pause : MonoBehaviour
{
	...
	void Paused()
	{
		...
		//fermare suono gioco								                //viene riprodotta la canzone della pausa
		//far partire musica pausa							                //viene ripresa la riproduzione della canzone principale
	...
	public void Resume()
	{
		...
		//fermare suono pausa 												//viene bloccata la canzone della pausa
		//far partire suono gioco							                //viene ripresa la riproduzione della canzone principale
																			//Cursor.lockState = CursorLockMode.Locked;                           //il cursore diventa invisibile e bloccato al centro
																			//Cursor.visible = false;
	}
